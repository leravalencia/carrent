...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_tingle_js__ = __webpack_require__("./node_modules/tingle.js/dist/tingle.min.js");
...
if (metaToken) {
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.headers.common['X-CSRF-TOKEN'] = metaToken.getAttribute('content');
}

var modal = new __WEBPACK_IMPORTED_MODULE_1_tingle_js___default.a.modal({
  footer: false,
  stickyFooter: false,
...
var showModalButton = document.querySelectorAll('.show-sign-up-modal');
if (showModalButton) {

  var loginModal = document.getElementById('js-login-modal');
...
var subscribeForm = document.getElementById('js-land-subscription-form');
if (subscribeForm) {
  subscribeForm.onsubmit = function (ev) {
    ev.preventDefault();
    var email = document.getElementById('js-land-subscribe_email').value;
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/subscribe', { email: email }).then(function (res) {
...
var feedbackForm = document.getElementById('js-land-feedback-form');
if (feedbackForm) {
  feedbackForm.onsubmit = function (ev) {
    ev.preventDefault();
    var name = document.getElementById('js-feedback_name').value;
    var email = document.getElementById('js-feedback_email').value;
    var message = document.getElementById('js-feedback_message').value;
    __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/feedback', {
      name: name,
      email: email,
      message: message
    }).then(function (res) {
